...
En este caso debido a que la app es modesta, se me ha facilitado realizar las pruebas desde al ejecucion y revison del codigo en todos los casos posibles de error
...
No tuve errores como tal, pero tuve que entender muy bien el codigo primero para poder implementar los cambios correctamente.
Este proceso de enteder el codigo se me hizo algo dificil ya que se manejan varias librerias y lenguajes de programacion que aun no tengo 
dominados. 
